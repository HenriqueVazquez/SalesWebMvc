...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            SalesRecord r6 = new SalesRecord(6, new DateTime(2023, 01, 15), 2000.0, SaleStatus.Billed, s1);
            ...
            SalesRecord r9 = new SalesRecord(9, new DateTime(2023, 01, 14), 11000.0, SaleStatus.Pending, s6);
            SalesRecord r10 = new SalesRecord(10, new DateTime(2023, 01, 7), 9000.0, SaleStatus.Billed, s6);
            SalesRecord r11 = new SalesRecord(11, new DateTime(2023, 01, 13), 6000.0, SaleStatus.Billed, s2);
            SalesRecord r12 = new SalesRecord(12, new DateTime(2023, 01, 25), 7000.0, SaleStatus.Pending, s3);
            SalesRecord r13 = new SalesRecord(13, new DateTime(2023, 01, 29), 10000.0, SaleStatus.Billed, s4);
